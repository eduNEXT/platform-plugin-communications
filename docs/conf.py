...
"""
Platform Plugin Communications documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'platform_plugin_communications',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/eduNEXT/platform_plugin_communications",
...
#
# html_title = 'Platform Plugin Communications v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'An Open edX plugin that extends email capabiliplatform',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'platform_plugin_communications'),
                os.path.join(root_path, 'platform_plugin_communications/migrations')])
