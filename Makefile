...
format: # format code with black and isort
	...
	isort platform_plugin_communications setup.py manage.py test_settings.py
...
extract_translations: ## extract strings to be translated, outputting .mo files
	cd platform_plugin_communications && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd platform_plugin_communications && i18n_tool generate

detect_changed_source_translations:
	cd platform_plugin_communications && i18n_tool changed
...
pull_translations:
	find platform_plugin_communications/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/platform_plugin_communications/platform_plugin_communications/conf/locale:platform_plugin_communications/conf/locale
...
dummy_translations: ## generate dummy translation (.po) files
	cd platform_plugin_communications && i18n_tool dummy
